...
while True:
    ...
    if choice == '1':
        ...
        new_status = input("Enter the new status  (pending, in-progress, complete): ")
        update_task_status(task_id, new_status)
    elif choice == '4':
        status = input("Enter status to filter by (pending, in-progress, complete): ")
...
# Ensure the connection is closed after the loop exits
conn.close()
